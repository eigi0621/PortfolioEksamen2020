...
function loadedState() {
  ...
  setTimeout(function () {
    document.querySelector(".indhold-text_wrapper1").classList.add("center_ani1");
  }, 350);

  setTimeout(function () {
    document.querySelector(".center_h1").style.visibility = "visible";
    document.querySelector(".indhold-text_wrapper2").classList.add("center_ani1");
...
function showScroll() {
  window.onscroll = function (e) {
    ...
    if (window.pageYOffset > 10) {
      ...
      setTimeout(function () {
        document.querySelector(".indhold-text_wrapper1").classList.remove("center_ani1");
        document.querySelector(".indhold-text_wrapper1").classList.add("center_ani1_back");
      }, 150);
      setTimeout(function () {
        document.querySelector(".indhold-text_wrapper2").classList.remove("center_ani1");
        document.querySelector(".indhold-text_wrapper2").classList.add("center_ani1_back");
      }, 200);
      ...
      setTimeout(function () {
        document.querySelector(".indhold-text_wrapper1").classList.remove("center_ani1_back");
        document.querySelector(".indhold-text_wrapper1").classList.add("center_ani1");
      }, 150);
      setTimeout(function () {
        document.querySelector(".indhold-text_wrapper2").classList.remove("center_ani1_back");
        document.querySelector(".indhold-text_wrapper2").classList.add("center_ani1");
      }, 200);
    ...
    if (window.matchMedia("(min-width: 800px)").matches) {
      ...
      if (window.pageYOffset > break1) {
        document.querySelector(".amager").style.transform = "translateY(" + imgSpeed2 + "px)";
        document.querySelector(".img_wrapper3_amager").style.transform = "translateY(" + wrapSpeed2 + "px)";
      ...
      if (window.pageYOffset > break2) {
        document.querySelector(".rasmus").style.transform = "translateY(" + imgSpeed3 + "px)";
        document.querySelector(".img_wrapper3_rasmus").style.transform = "translateY(" + wrapSpeed3 + "px)";
