...
function loadedState() {
  ...
  setTimeout(function () {
    document.querySelector(".ux-text_wrapper1").classList.add("center_ani1");
  }, 350);

  setTimeout(function () {
    document.querySelector(".center_h1").style.visibility = "visible";
    document.querySelector(".ux-text_wrapper2").classList.add("center_ani1");
...
function showScroll() {
  window.onscroll = function (e) {
    ...
    if (window.pageYOffset > 10) {
      ...
      setTimeout(function () {
        document.querySelector(".ux-text_wrapper1").classList.remove("center_ani1");
        document.querySelector(".ux-text_wrapper1").classList.add("center_ani1_back");
      }, 150);
      setTimeout(function () {
        document.querySelector(".ux-text_wrapper2").classList.remove("center_ani1");
        document.querySelector(".ux-text_wrapper2").classList.add("center_ani1_back");
      }, 200);
      ...
      setTimeout(function () {
        document.querySelector(".ux-text_wrapper1").classList.remove("center_ani1_back");
        document.querySelector(".ux-text_wrapper1").classList.add("center_ani1");
      }, 150);
      setTimeout(function () {
        document.querySelector(".ux-text_wrapper2").classList.remove("center_ani1_back");
        document.querySelector(".ux-text_wrapper2").classList.add("center_ani1");
      }, 200);
