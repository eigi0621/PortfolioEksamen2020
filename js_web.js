...
function loadedState() {
  ...
  setTimeout(function () {
    document.querySelector(".web-text_wrapper1").classList.add("center_ani1");
  }, 350);

  setTimeout(function () {
    document.querySelector(".center_h1").style.visibility = "visible";
    document.querySelector(".web-text_wrapper2").classList.add("center_ani1");
...
function showScroll() {
  window.onscroll = function (e) {
    ...
    var break2 = document.querySelector(".col_wrapper5").getBoundingClientRect().top + window.pageYOffset - window.innerHeight;

    var imgSpeed = window.pageYOffset * speedOfImg - 100 * speedOfImg + 100;
    var wrapSpeed = window.pageYOffset * speedOfWrap - 100 * speedOfWrap;
    var imgSpeed3 = window.pageYOffset * speedOfImg2 - break1 * speedOfImg2 + 100;
    var wrapSpeed3 = window.pageYOffset * speedOfWrap2 - break1 * speedOfWrap2;
    var wrapSpeed5 = window.pageYOffset * speedOfWrap5 - break2 * speedOfWrap5;
    ...
    if (window.pageYOffset > 10) {
      ...
      setTimeout(function () {
        document.querySelector(".web-text_wrapper1").classList.remove("center_ani1");

        document.querySelector(".web-text_wrapper1").classList.add("center_ani1_back");
      }, 150);
      setTimeout(function () {
        document.querySelector(".web-text_wrapper2").classList.remove("center_ani1");

        document.querySelector(".web-text_wrapper2").classList.add("center_ani1_back");
      }, 200);
      ...
      setTimeout(function () {
        document.querySelector(".web-text_wrapper1").classList.remove("center_ani1_back");

        document.querySelector(".web-text_wrapper1").classList.add("center_ani1");
      }, 150);
      setTimeout(function () {
        document.querySelector(".web-text_wrapper2").classList.remove("center_ani1_back");
